        ...
        body: SafeArea(
          ...
          child: Column(
            children: [
              Center(
                child: SizedBox(
                  child: Image.asset('assets/log/LOGO-icon---Black.png',
                      fit: BoxFit.cover, width: screenWidth * 0.3),
                ),
              ),
              ...
              SingleChildScrollView(
                  ...
                  child: Row(
                    children: [
                      FeaturedProductCard(screenWidth: screenWidth, screenHeight: screenHeight),
                      FeaturedProductCard(screenWidth: screenWidth, screenHeight: screenHeight),
                      FeaturedProductCard(screenWidth: screenWidth, screenHeight: screenHeight),
                    ],
                  )),
